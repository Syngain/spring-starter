...
public class HLBizMsgCrypt {
     ...
     * 构造函数
     *
     * @param token          平台上，开发者设置的token
     * @param encodingAesKey 平台上，开发者设置的EncodingAESKey
     * @param appid          平台appid
     * @throws AesException 执行失败，请查看该异常的错误码和具体的错误信息
     */
    public HLBizMsgCrypt(String token, String encodingAesKey, String appid) throws AesException {
